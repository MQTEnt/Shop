...
-- Dumping data for table pc_shop.category: ~4 rows (approximately)
...
-- Dumping data for table pc_shop.order: ~0 rows (approximately)
...
-- Dumping data for table pc_shop.order_has_product: ~3 rows (approximately)
...
-- Dumping data for table pc_shop.product: ~18 rows (approximately)
...
-- Dumping data for table pc_shop.user: ~4 rows (approximately)
